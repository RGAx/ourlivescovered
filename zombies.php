<?php require_once('header.html'); ?>
	...
	<section id="zombies_hero" class="section-photo cover text-center">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1>Protecting your family: it's a no-brainer</h1>
                    <p id="zombies_copy">Death isn't a typical concern for young healthy people. Term life insurance is often the best option for protecting against the unexpected.</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="form-wrapper">
                        <div class="primary-container">
                            ...
                            <div class="gobutton-container">
                                <input type="button" class="btn btn-primary" value="Start Prepping" id="main-affordable-form" wpvalue="continue" onclick="return validatePremiumMlc();">
                            </div>
                        </form>
                    </div>
                </div>
