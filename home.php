...
<div class="container-fluid">
    <div id="hero" class="homepage">
        <div class="main-cta">
            ...
            <form class="cta-form" action="quote-form.php" method="POST" id="home-form">
        ...
        <div id="quiz-inner">
            ...
            <div class="row quiz-content text-center hide-item" id="quiz-content-10">
                <div class="col-xs-8 col-xs-offset-2">
                    ...
                    <div class="row quiz-btn-row">
                        <div class="col-xs-8 col-xs-offset-2"> <a class="btn quiz-cta" href="quote-form.php">Get a Quote</a><br><a href="javascript:openHomeLink()">Restart Quiz</a></div>
                    </div>
                </div>
            </div>
            <div class="clear"></div>
